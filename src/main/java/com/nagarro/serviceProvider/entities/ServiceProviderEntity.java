...
public class ServiceProviderEntity {
	...
	public String toString() {
		return "ServiceProviderEntity [serviceProviderId=" + serviceProviderId + ", serviceProviderName="
				+ serviceProviderName + ", mobileNumber=" + mobileNumber + ", serviceId=" + serviceId + ", availablity="
				+ availablity + "]";
	}
